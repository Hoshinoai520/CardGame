        ...
        private static object RenderUI(JObject @params)
        {
            ...
            if (Application.isPlaying)
            {
                ...
                if (s_pendingCaptureDone && s_pendingCaptureTex != null)
                {
                    ...
                    byte[] capturePng = TextureOps.EncodeTextureToPng(captureTex);
                    ...
                    if (includeImage)
                    {
                        ...
                        try
                        {
                            ...
                            if (captureW > targetMax || captureH > targetMax)
                            {
                                ...
                                playData["imageBase64"] = Convert.ToBase64String(TextureOps.EncodeTextureToPng(downscaled));
            ...
            try
            {
                ...
                byte[] png = TextureOps.EncodeTextureToPng(tex);
                ...
                if (includeImage)
                {
                    ...
                    try
                    {
                        if (width > targetMax || height > targetMax)
                        {
                            ...
                            data["imageBase64"] = Convert.ToBase64String(TextureOps.EncodeTextureToPng(downscaled));
